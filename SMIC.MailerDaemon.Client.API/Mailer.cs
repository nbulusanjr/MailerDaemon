...
namespace SMIC.MailerDaemon.Client.API
{
    public static class Mailer
    {
        ...
        public static Mails mails { get; set; }
        ...
        public static async Task<string> RunAsync()
        {
            ...
            HttpResponseMessage response = await client.PostAsJsonAsync(Endpoint + "api/Mailer", mails);
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                //return string.Format("HTTP Status: {0}, Reason {1}. Press ENTER to exit", response.StatusCode, response.ReasonPhrase);
            }
            else
            {
               ...
               // return string.Format("Failed to call the API. HTTP Status: {0}, Reason {1}", response.StatusCode, response.ReasonPhrase);
