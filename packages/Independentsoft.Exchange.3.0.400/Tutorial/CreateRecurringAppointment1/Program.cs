    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                recurrence.Pattern = new DailyRecurrencePattern(1);
                recurrence.Range = new NumberedRecurrenceRange(DateTime.Today, 10);

                Appointment appointment = new Appointment();
                appointment.Subject = "Daily recurrence next 10 days";
