    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //Montly recurrence. Every 15th day of the second month               
                Recurrence recurrence = new Recurrence();
                recurrence.Pattern = new AbsoluteMonthlyRecurrencePattern(2, 15);
                recurrence.Range = new NoEndRecurrenceRange(DateTime.Today);

                Appointment appointment = new Appointment();
                appointment.Subject = "Every second month";
